...
<footer style="background:#1a1a2e;color:rgba(255,255,255,.6);text-align:center;padding:20px;font-size:12px">
  ...
  Site à usage interne - <a href="methodologie.html" style="color:rgba(255,255,255,.8)">Voir la méthodologie</a><br>
  Réalisé par Julien Vieira en collaboration avec <a href="https://www.linkedin.com/in/henricasalis/" target="_blank" rel="noopener" style="color:rgba(255,255,255,.8)">Henri Casalis</a>
</footer>
</body>
</html>"""
